...
/*	for (i = 0; i < T0_LEDNUM; i++) {*/
		Chip_GPIO_SetPinDIROutput(LPC_GPIO_PORT, 0, GPS_LED_PIN);
...
{
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, 0, GPS_LED_PIN, true);
}
/*********************************************************************/
void Deactivate_GPS_LED()
{
	Chip_GPIO_SetPinState(LPC_GPIO_PORT, 0, GPS_LED_PIN, false);
}
/*********************************************************************/
...
void Board_LED_Toggle(uint8_t LEDNumber)
{
	/*if (LEDNumber < T0_LEDNUM) {*/
		Chip_GPIO_SetPinToggle(LPC_GPIO_PORT, 0, GPS_LED_PIN);
	/*}*/
}
/*********************************************************************/
//                                      16   12   5
