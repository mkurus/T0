...
typedef struct SPIM_XFER {
	...
	int16_t rxCount;				/** Size of the pRXData buffer in items (not bytes), modified by driver */
	int16_t txCount;				/** Number of items (not bytes) to send in pTXData buffer, modified by driver */
	int16_t dataRXferred;			/** Total items (not bytes) received, modified by driver */
	int16_t dataTXferred;			/** Total items (not bytes) transmitted, modified by driver */
